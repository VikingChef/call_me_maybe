"""Filter model tokens against the current constrained-generation state."""
...
def is_valid_continuation(
    ...
    """Return whether text can be added without invalidating the state."""
...
def is_valid_token(
    ...
    """Return whether a token is a valid continuation of the current state."""
...
def filter_valid_tokens(
    ...
    """Return token IDs and scores that satisfy the current constraints."""
    valid_tokens = []
...
def choose_best_valid_token(
    ...
    """Return the highest-scoring token that satisfies all constraints."""
